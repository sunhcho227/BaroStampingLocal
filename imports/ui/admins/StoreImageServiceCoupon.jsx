...
const StoreImageServiceCoupon = () => {
  ...
  const getImagePath = (storeUrlName, type) => {
    if (!storeUrlName || !type) return "/stores/default_service_coupon.png";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <div className="relative group">
          <img
            ...
            onError={(e) => {
              e.target.src = "/stores/default_service_coupon.png"; // 기본 이미지로 대체
            }}
          />
        </div>
      </div>
...
export default StoreImageServiceCoupon;
