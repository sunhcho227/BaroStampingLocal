...
export default () => {
  ...
  return (
    <>
      <div className="order-page-container tap">
        ...
        <div className="order-info-box tap">
              ...
              return (
                <div key={product._id} className="product-item">
                  <label>
                    ...
                    className="h-5 w-5 rounded-md mr-1 text-[#00A9B5] focus:ring-2 focus:ring-[#00A9B5]"
                    />
