    ...
    <>
      ...
      <div className="profile-edit-container">
        ...
        <div className="profile-field">
            <div className="text_title_xs profile_keyarea"><span className="primary">*</span>아이디</div>
          ...
          <div className="profile-field">
            <div className="text_title_xs profile_keyarea"><span className="primary">*</span>닉네임</div>
            <div className="custom-inputbox-container">
              <input
                className="custom-inputbox"
                type="text"
          ...
          <div className="profile-field">
            <div className="text_title_xs profile_keyarea"><span className="primary">*</span>비밀번호</div>
            <div className="custom-inputbox-container">
              <input
                className="custom-inputbox"
                type="password"
          ...
          <div className="profile-field">
            <div className="text_title_xs profile_keyarea"><span className="primary">*</span>비밀번호 확인</div>
            <div className="custom-inputbox-container">
              <input
                className="custom-inputbox"
                type="password"
        ...
        <div className="profile-btn-actions">
            <button onClick={handleSave} className="btn-primary">가입 하기</button>
          </div>
