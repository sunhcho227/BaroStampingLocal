...
export default () => {
  ...
  // qr 정보
  const qrData = JSON.stringify({ coupon_id: coupon?._id });
  const qrSize = 160;
      ...
      <div className="usingcoupon-page-container">
        ...
        <div className="coupon-header">
          <div className="coupon-card">
            <div className="coupon-qr-img"></div>
            ...
            <div className="coupon-details">
              ...
              <div className="coupon-detail-item">
                ...
                <div className="text_body_l">~ {expirationDate.toLocaleDateString()}</div>
              </div>
              <div className="coupon-detail-item">
                <div className="text_title_xs">쿠폰번호</div>
                <div className="text_body_l">{Coupons.findOne({ _id: couponId })._id}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="coupon-store-info">
          ...
          <div className="coupon-store-map-placeholder"></div>
        </div>
